...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-08-2026 a las 21:24:33
...
--
-- Base de datos: `hospital de clínicas`
--
...
CREATE TABLE `ambulancia` (
  ...
  `numero_de_serie` int(15) DEFAULT NULL,
...
--
ALTER TABLE `acompaniante`
  MODIFY `id_acompaniante` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `acompaniante`
  ADD CONSTRAINT `acompaniante_ibfk_1` FOREIGN KEY (`id_acompaniante`) REFERENCES `persona` (`id_persona`);

--
-- Filtros para la tabla `ambulancia`
--
ALTER TABLE `ambulancia`
  ADD CONSTRAINT `ambulancia_ibfk_1` FOREIGN KEY (`id_ambulancia`) REFERENCES `traslado` (`id_traslado`);
...
--
ALTER TABLE `funcionario`
  ADD CONSTRAINT `funcionario_ibfk_1` FOREIGN KEY (`id_funcionario`) REFERENCES `persona` (`id_persona`);
...
--
ALTER TABLE `tipo`
  ADD CONSTRAINT `tipo_ibfk_1` FOREIGN KEY (`id_tipo`) REFERENCES `funcionario` (`id_funcionario`);
