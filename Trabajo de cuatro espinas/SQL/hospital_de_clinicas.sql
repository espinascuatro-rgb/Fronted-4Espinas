...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2026 a las 19:29:44
...
INSERT INTO `funcionario` (`id_tipo`, `usuario`, `contrasenia`, `credenciales`, `cedula`) VALUES
('123', 'Lautaro DelCampo', '$2y$10$xHKPDFr0ZCYVUpaJEkAYqeo', 'nolastiene', NULL),
('1234', 'Rodrigo', '$2y$10$r6aDTeklibCxlcIeF3PKQO9LYW1hRqAQgBHB9HUJ9SNiQPQlIzxt.', 'notiene', NULL),
('123456', 'Juancito', '$2y$10$l4D7sHdyE0YGhKQ8ZlX3ueZ', 'Si', NULL),
('1234567', 'Pepe', '$2y$10$CMX7f4SGOF1nW66xlK4cJ.b', 'Silastien', NULL),
('12345678', 'Josue', '$2y$10$Ijyws09zJaf5HhoHlxFIU.PjCSZCw.aCqGXycymywO2VoU8aq1vFi', 'Sitiene', NULL),
('87654321', 'Jose Gervasio', '$2y$10$qrftpHp6Q0UVo6nKFXWxh.M', 'sitiene', NULL);
...
INSERT INTO `persona` (`cedula`, `carne_de_salud`, `numero_de_telefono`, `direccion`) VALUES
('123', 'vivoporahora', '092876543', 'Sucasa'),
('1234', 'vivito', '09821345', 'Sucaza'),
('123456', 'vivo', '09843685', 'Su casa'),
('1234567', 'Vivo', '098234876', 'Tacuarembo'),
('12345678', 'Vivo', '098676767', 'Jan Mayen'),
('56767837', 'vejez', '098564430', 'narnia'),
('87654321', 'vivo', '098777067', 'Tete Mozambique');
